...
public class Problema3_EjecutorInstitucionEducativa {
    public static Problema3_InstitucionEducativa InstitucionX = new Problema3_InstitucionEducativa();
    public static void main(String [] args){
        Scanner sc = new Scanner(System.in);
        
        System.out.print("Ingrese el Nombre de la Insitucion: ");
        String nombre = sc.nextLine();
        System.out.print("Ingrese el Nombre el Tipo de Institucion: ");
        ...
        System.out.print("Ingrese el Gasto por Estudiante: ");
        double gastosEstudiante = sc.nextDouble();
        
        InstitucionX.setNombre(nombre);
        InstitucionX.setTipo(tipo);
        InstitucionX.setNumAlumnos(numAlumnos);
        InstitucionX.setNumDocentes(numDocentes);
        InstitucionX.setNumSedes(numSedes);
        InstitucionX.setGastosEstudiante(gastosEstudiante);
        InstitucionX.calcularPresupuesto();
        
        System.out.println("\nInsitucion Educativa \n" + InstitucionX.toString());
